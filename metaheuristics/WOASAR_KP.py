...
def WOASAR_KP(id,instance_file,instance_dir,population,maxIter,discretizacionScheme,ql_alpha,ql_gamma,repair,policy,rewardType,qlAlphaType):
    ...
    matrixBin,fitness,solutionsRank = Problem.KP(poblacion,matrixBin,solutionsRank,DS_actions[DS],repair,numItem, knapsackSize, weightItems,valueItems)
    #fitness.append(valorFitness)
